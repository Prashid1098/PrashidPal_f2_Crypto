...
function showPanel(idx){
    ...
    if(idx == 1){
        ...
        grid_btn.style.color="rgb(60, 120, 205)";
        ...
        list_btn.style.color="rgb(60, 120, 205)";
        grid_btn.style.color="white";
...
function pushGridContent(){
    arr.forEach(element => {
        ...
        <div>
        <img class="card-img" style="width:20%;" src="${element.image}" alt="${element.name}">
        </div>
        <div card-tile>
...
function pushListContent(){
    ...
    arr.forEach((element) => {
        ...
        <td>
        <div card-tile>
        <div style="width: 20px">${element.symbol}</div>
        <div style="color: #f3f3f3">${element.name}</div>
        </div>
        </td>
        <td>
        ...
        <td>
        <div style="margin-bottom: 2px; font-size:13px; font-weight:bold color:#f3f3f3b9; padding:0 1em;">${element.total_volume.toLocaleString()}</div>
        </td>
        <td>
        <div>
        <div style="margin-bottom: 2px; font-size:13px; font-weight:bold color:#f3f3f3b9; padding:0 1em;">${element.market_cap.toLocaleString()}</div>
        </td>`
